...
const PageNotFound = () => {
  return (
    <Grid templateColumns={"1fr 1fr"} h={"100vh"} w={"100%"} bg={"#131313"}>

        <Flex alignItems={"center"} justifyContent={"center"} flexDir={"column"}>
            <Text className="header-logo-text" fontSize={"150px"} mb={"-50px"} fontWeight={"500"}>404</Text>
            <Text fontSize={"60px"} color={"#232323"} fontWeight={"500"}>PAGE NOT FOUND</Text>
            <Text fontSize={"15px"} color={"#333"}>The requested URL was not found on this server.</Text>
